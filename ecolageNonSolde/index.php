    ...
    <div class="ui grid">
        <div class="row">
            <div class="column sixteen wide">
                <div class="etatEcolage" style="background-color: #DB2828;">
                    <b>Etat d'écolage au solde non versé <?=date('d-m-Y'); ?></b>
                </div><br />
...
?>
 ...
 <script>
    $(document).ready(function() {
        ...
        $.post("/PROJET_ADEC/ecolageNonSolde/control.php",{classeEleve:classeEleve}, function(data) {
