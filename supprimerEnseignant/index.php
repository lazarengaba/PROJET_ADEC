<?php
    ...
    <div style="margin-left: 20px; font-size: 13px;">
        Voulez-vous vraiment supprimer <b><?=$data['nom_enseignant']." ".$data['prenom_enseignant']; ?></b> de la liste ?&nbsp;&nbsp;
...
?>
    ...
    <script>
        $('#supprimerEleveBouton').click(function() {
            ...
            $.post('/PROJET_ADEC/supprimerEnseignant/control.php',{matriculeEleve:matriculeEleve}, function(data) {
                window.close();
            });
        });
