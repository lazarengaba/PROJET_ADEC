<?php
    ...
    <div style="margin-left: 20px; font-size: 13px;">
        Voulez-vous vraiment supprimer <b><?=$data['nom_de_famille']." ".$data['prenom']; ?></b> de la liste ?&nbsp;&nbsp;
...
?>
    ...
    <script>
        $('#supprimerEleveBouton').click(function() {
            ...
            $.post('/PROJET_ADEC/supprimerEleve/control.php',{matriculeEleve:matriculeEleve}, function(data) {
                window.close();
            });
        });
