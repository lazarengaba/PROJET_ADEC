<?php
    ...
    <div class="ajouterClasseContainer"><br />
        <div class="title">
            <i class="trash icon"></i><b>Supprimer une classe</b><br /><br />
    ...
    <div style="font-size: 13px;">
        ...
        <table>
            <tr>
                <td>
                    Saisir le nom de la classe à supprimer
        ...
        $(document).ready(function() {
           ...
           $('#chercheClasseModifier').keyup(function() {
               if ($('#chercheClasseModifier').val().length>=3) {
                   ...
                   $.post('/PROJET_ADEC/traitementsAjax/rechercherClasseSupp.php', {chercheClasseModifier:chercheClasseModifier}, function(data) {
