<?php
    ...
    <div class="ajouterClasseContainer"><br />
        <div class="title">
            <i class="search icon"></i><b>Rechercher un (e) élève</b><br /><br />
    ...
    <table>
            <tr>
                <td>
                    Saisir le nom, prénom ou matricule à rechercher
        ...
        $(document).ready(function() {
           ...
           $('#chercheClasseModifier').keyup(function() {
               if ($('#chercheClasseModifier').val().length>=3) {
                   ...
                   $.post('/PROJET_ADEC/traitementsAjax/rechercheEleveAfficher.php', {chercheClasseModifier:chercheClasseModifier}, function(data) {
