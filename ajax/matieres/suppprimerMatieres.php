<?php
    ...
    <div class="ajouterClasseContainer"><br />
        <div class="title">
            <i class="trash icon"></i><b>Supprimer une matière</b><br /><br />
    ...
    <div style="font-size: 13px;">
        <table>
            <tr>
                <td>
                    Saisir le nom de la matière à supprimer
        ...
        $(document).ready(function() {
           ...
           $('#nomMatiereModif').keyup(function() {
               ...
               if (nomMatiereModif.length>=1) {
                   ...
                   $.post('/PROJET_ADEC/traitementsAjax/rechercheMatiereSupp.php', {nomMatiereModif:nomMatiereModif}, function(data) {
