<?php
    ...
    <div class="ajouterClasseContainer"><br />
        <div class="title">
            <i class="edit icon"></i><b>Supprimer les information d'un (e) enseignant (e) de la liste</b><br /><br />
        ...
        $(document).ready(function() {
           ...
           $('#chercheClasseModifier').keyup(function() {
               if ($('#chercheClasseModifier').val().length>=3) {
                   ...
                   $.post('/PROJET_ADEC/traitementsAjax/rechercheEnseignantSupprimer.php', {chercheClasseModifier:chercheClasseModifier}, function(data) {
