<?php
    ...
    <div class="ajouterClasseContainer"><br />
        <div class="title">
            <i class="edit icon"></i><b>Modifier les information d'un (e) enseignant (e)</b><br /><br />
    ...
    <div style="font-size: 13px;">
        <table>
            <tr>
                <td>
                    Saisir le nom, prénom ou matricule de l'enseignant (e) à modifier
        ...
        $(document).ready(function() {
           ...
           $('#chercheClasseModifier').keyup(function() {
               if ($('#chercheClasseModifier').val().length>=3) {
                   ...
                   $.post('/PROJET_ADEC/traitementsAjax/rechercheEnseignantModifier.php', {chercheClasseModifier:chercheClasseModifier}, function(data) {
