...
?>
            <tr>
                ...
                <td>
                    <a target="_blank" href="/PROJET_ADEC/supprimerEnseignant/?matricule=<?=$data['mle_enseignant']; ?>" class="ui red button mini" style="border-radius: 0;float: right;">Supprimer</a>
                </td>
            </tr>
<?php
        }
