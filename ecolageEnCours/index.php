    ...
    <div class="ui grid">
        <div class="row">
            <div class="column sixteen wide">
                <div class="etatEcolage" style="background-color: #F2711C;">
                    <b>Etat d'écolage non soldé du <?=date('m-d-Y'); ?></b>
                </div><br />
...
?>
 ...
 <script>
    $(document).ready(function() {
        ...
        $.post("/PROJET_ADEC/ecolageEnCours/control.php",{classeEleve:classeEleve}, function(data) {
