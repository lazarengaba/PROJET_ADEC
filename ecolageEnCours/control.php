<?php
    ...
    $req = "SELECT * FROM eleves LEFT OUTER JOIN classes ON classe_eleve = id_classe WHERE solde_verse != 0 AND solde_verse < solde_ecolage AND id_classe = ? ORDER BY nom_de_famille";
